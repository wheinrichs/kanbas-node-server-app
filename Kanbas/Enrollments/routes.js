...
export default function EnrollmentRoutes(app) {
    ...
    app.get("/api/enrollments/:student/courses", async (req, res) => {
        const student = req.params.student;
        const enrollments= await dao.findEnrollmentsByStudent(student);
        const courses= enrollments.map((e) => e.course);
        res.json(courses);
    });
    app.get("/api/enrollments/:course/students", async (req, res) => {
    ...
    app.delete("/api/enrollments/course/:courseId", async (req, res) => {
        ...
        const result = await dao.unenrollStudentFromCourse(currentUser._id, courseId);
        res.json(result);
    });
